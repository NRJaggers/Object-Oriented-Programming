		...
		void  Vehicle :: displayHead()
			{
				...
				cout << setw(24) << "Last Service Date" ;
		...
		void  Vehicle :: displayData()
			{
				...
				cout << setw(13)  << getLastServiceDate() ;
	...
	void  Bus :: displayData()
				{
					...
					cout << setw(11) << getCapacity() ;
					cout << setw(8)  << getStatus() ;
					cout << setw(11) << mileage ;
					cout << setw(12) << tireSize ;
					cout << setw(7)  << fuelType ;
				}
	void Bus :: maintenance()
				{
					if(mileage > 25000)
						setStatus('M');
				}
	...
	void  Railcar :: displayData()
				{
					...
					cout << setw(11) << getCapacity() ;
					cout << setw(8)  << getStatus() ;
					cout << setw(15) << powerOnDuration ;
					cout << setw(17) << motorType ;
				}
	void Railcar :: maintenance()
					{
							if(powerOnDuration >= 100)
								setStatus('M');
					}
//destructor
	...
	void  Helicopter :: displayHead()
				{
					...
					cout << setw(10) << "Capacity" ;
					cout << setw(8)  << "Status" ;
					cout << setw(23) << "Air Frame Flight Time" ;
					cout << setw(13) << "Engine Time" ;
					cout << "\n--------------------------------------------------------------------------------------" ;
					cout << "------------------------------------------\n" ;
				}
	void  Helicopter :: displayData()
				{
					...
					cout << setw(11) << getCapacity() ;
					cout << setw(8)  << getStatus() ;
					cout << setw(18) << afFlightTime ;
					cout << setw(18) << engineTime ;
				}
	void Helicopter :: maintenance()
					{
						if((afFlightTime >= 1000) or (engineTime >= 750))
							setStatus('M');
					}
//destructor
