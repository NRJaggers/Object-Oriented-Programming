...
GroceryItem eggs;
 ...
 //compare these results to operator overloading from 10-21
 //compare the GroceryItem cpp files where the operator is
 //overloaded and see how things are different
